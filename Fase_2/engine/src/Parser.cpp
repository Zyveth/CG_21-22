...
void Parser::parseCamera()
{
    ...
    this->camera.setXPos(x_pos);

    float y_pos;
    position->QueryFloatAttribute("y", &y_pos);
    this->camera.setYPos(y_pos);

    float z_pos;
    position->QueryFloatAttribute("z", &z_pos);
    this->camera.setZPos(z_pos);
    ...
    this->camera.setXLookAt(x_lookAt);

    float y_lookAt;
    lookAt->QueryFloatAttribute("y", &y_lookAt);
    this->camera.setYLookAt(y_lookAt);

    float z_lookAt;
    lookAt->QueryFloatAttribute("z", &z_lookAt);
    this->camera.setZLookAt(z_lookAt);
    ...
    this->camera.setXUp(x_up);

    float y_up;
    up->QueryFloatAttribute("y", &y_up);
    this->camera.setYUp(y_up);

    float z_up;
    up->QueryFloatAttribute("z", &z_up);
    this->camera.setZUp(z_up);
